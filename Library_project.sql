...
ALTER TABLE library_project_2.dbo.branch
...
select 
	issued_emp_id,
	count(issued_emp_id) as total_books_issued
from issue
group by issued_emp_id
...
select * from members
where reg_date >= dateadd(day,-500,CURRENT_TIMESTAMP) 
